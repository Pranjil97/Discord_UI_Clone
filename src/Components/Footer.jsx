...
const Footer = () => {
  return (
    <div>
      <footer className="bg-[#23272a] sm:w-full sm:h-[910px] 2xl:w-full 2xl:h-[550px]">
        <div className=" sm:w-full 2xl:h-[550px] 2xl:w-[1280px] 2xl:mx-auto">
          <div className=" sm:flex sm:flex-col 2xl:h-[390px] 2xl:flex 2xl:flex-row">
            <div className=" sm:w-[600px] 2xl:w-[400px] 2xl:flex 2xl:flex-col 2xl:p-9">
              <div className="sm:flex 2xl:flex 2xl:flex-col">
                <div className="mt-[30px] ml-[30px] w-[250px] text-[#5865f2] font-black text-[40px] tracking-tighter">
                  IMAGINE A
                </div>
                <div className="sm:mt-[30px] sm:-ml-[35px] sm:text-[40px] 2xl:-mt-[20px] 2xl:ml-[30px] 2xl:w-[250px] text-[#5865f2] font-black 2xl:text-[40px] tracking-tighter">
                  PLACE
                </div>
              </div>
            ...
            <div className="sm:ml-[30px] sm:flex sm:flex-col sm:justify-between sm:flex-wrap sm:mx-auto sm:h-[570px] sm:space-x-[0px] sm:w-[500px] 2xl:ml-[80px] 2xl:w-full 2xl:h-full 2xl:flex 2xl:flex-row 2xl:space-x-0 space-x-[120px]">
              <div className="sm:order-1 sm:ml-[0px] sm:mt-[70px] 2xl:mt-[90px] 2xl:h-full 2xl:ml-[50px] space-y-[6px] text-white">
              ...
              <div className="sm:order-2 sm:mt-[70px] 2xl:mt-[90px] 2xl:h-full space-y-[6px] text-white">
              ...
              <div className="sm:order-1 mt-[90px] space-y-[6px] text-white 2xl:h-full">
              ...
              <div className="sm:order-4 sm:mb-[58px] sm:mt-[0px] 2xl:mt-[90px] 2xl:mb-0 2xl:h-full space-y-[6px] text-white">
          ...
          <div className="sm:w-[570px] sm:ml-[30px] sm:h-[1px] sm:mt-[40px] bg-[#5865f2] 2xl:w-[1210px] 2xl:ml-[55px] 2xl:mt-10 2xl:h-[1px]"></div>
          <div className="sm:w-full w-full h-[90px] flex items-center">
            <img
              src={discord}
              alt="Discord"
              className="sm:ml-[30px] h-[35px] 2xl:ml-[58px] cursor-pointer"
            />
            <button className="sm:ml-[360px] h-10 w-20 rounded-full text-sm text-white bg-[#5865f2] hover:bg-[#737df5] hover:shadow-blue-900 2xl:ml-[1000px]">
              Sign up
            </button>
          </div>
        </div>
